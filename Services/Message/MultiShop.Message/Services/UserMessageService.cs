...
namespace MultiShop.Message.Services
{
    public class UserMessageService : IUserMessageService
    {
        ...
        {
            var values = await _messageContext.UserMessages.Where(x=>x.ReveiverId == id).ToListAsync();
        ...
        {
            var values = await _messageContext.UserMessages.Where(x => x.ReveiverId == id).CountAsync();
            return values;
        }
